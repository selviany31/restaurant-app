...
const createRestaurantDetailTemplate = (restaurant) => `
  <div class="detail-item">
    <img tabIndex="0" class="detail-item__thumbnail"
            src="${CONFIG.BASE_IMAGE_URL + restaurant.pictureId}"
            alt="${restaurant.name}">
  ...
  <div id="customer-reviews">
    ...
    <div>
      <input type="text" id="fname" placeholder="Input your name..." class="review-input"><br>
      <textarea type="text" id="freview" placeholder="Input your review..." rows="7" class="review-input"></textarea><br>
